...
export const PromptInputBox = React.forwardRef(
  (props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
    const {
      onSend = () => {},
      isLoading = false,
      placeholder = "Ask BrainDock anything...",
      className,
    } = props;
      ...
      <>
        <PromptInput
          ...
          className={cn(
            ...
            (isFocused || input.trim().length > 0) && "scale-[1.02] shadow-[0_12px_40px_rgba(0,0,0,0.35)]",
            className
          )}
          disabled={isLoading}
          ...
          <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
            ...
            >
              <PromptInputAction tooltip="Upload image">
                ...
                >
                  <Paperclip className="h-5 w-5 text-inherit transition-colors" />
                  <input
                    ref={uploadInputRef}
                    type="file"
                    className="hidden"
